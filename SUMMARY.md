...
* [Linux 下部署 Seafile 服务器](deploy/README.md)
   * [用Docker部署 Seafile 服务](deploy/deploy_with_docker.md)
...
* [部署 Seafile 专业版服务器](deploy_pro/README.md)
   ...
   * 高级维护工具
       ...
       * [Seafile实时备份](deploy_pro/real_time_backup)
...
* [服务器个性化配置](config/README.md)
   ...
   * [桌面客户端定制](config/desktop_customization.md)
...
* [管理员控制面板](system_admin/admin_control_panel.md)
